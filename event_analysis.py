...
def get_events(data_folder, source="", regen=False):
    ''' Function processes .tokens files generated by BookNLP in a given folder to extract a dictionary of dated events for each file.
        ...
        Args:
            ...
            source - the name of an alternate sentence division process with the sentence numbers in a column called {source}_sentence_ID in the {filename} + "_" + {source} + ".csv" file. The rest of this file at a minimum must include the following columns: event, 
...
if __name__ == '__main__':
    ...
    events = get_events(data_root, source=source)
